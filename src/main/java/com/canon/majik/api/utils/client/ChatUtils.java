...
public class ChatUtils implements Globals {
    ...
    public static void tempMessage(String message, int code) {
        ...
        */
        switch (code){
            case 1:
                itc = new TextComponentString(chatPrefix + ChatFormatting.RED + message + ChatFormatting.RESET);
                break;
            case 2:
                itc = new TextComponentString(chatPrefix + ChatFormatting.GREEN + message + ChatFormatting.RESET);
                break;
            case 3:
                itc = new TextComponentString(chatPrefix + ChatFormatting.YELLOW + message + ChatFormatting.RESET);
                break;
        }
